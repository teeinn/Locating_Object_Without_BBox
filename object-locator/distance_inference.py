...
try:
    testset = build_dataset(args.pathOut,
...
print("dataset_loading_time:{}".format(end_dataset-start_dataset))
print("first process:{}".format(end_first-start_first))
print("mouse clicking:{}".format(end_ - start_))
print("total_cal_time:{}".format(end__-start__))
